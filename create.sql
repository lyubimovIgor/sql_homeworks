...
CREATE TABLE IF NOT EXISTS mixes_tracks_albums (
mix_id INTEGER REFERENCES mixes(id),
album_id INTEGER REFERENCES albums(id),
PRIMARY KEY (mix_id, album_id)
);

CREATE TABLE IF NOT EXISTS mixes_tracks_albums_tracks (
mix_id INTEGER REFERENCES mixes(id),
album_id INTEGER REFERENCES albums(id),
track_id INTEGER REFERENCES tracks(id),
PRIMARY KEY (mix_id, album_id, track_id)
);